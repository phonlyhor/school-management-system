...
const menuTranslations = {
    ...
    'Schedule': { kh: 'កាលវិភាគបង្រៀន', en: 'Schedule' },
    'Homeroom Schedule': { kh: 'កាលវិភាគថ្នាក់បន្ទុក', en: 'Homeroom Schedule' },
    ...
    'Scores': { kh: 'បញ្ចូលពិន្ទុសិស្ស', en: 'Scores' },
    'Student Scores': { kh: 'ពិន្ទុសិស្ស', en: 'Student Scores' },
    'Report Cards': { kh: 'សៀវភៅតាមដាន', en: 'Report Cards' },
    'Student Promotion': { kh: '🎓 ដំឡើងថ្នាក់សិស្ស', en: '🎓 Student Promotion' },
    'សៀវភៅតាមដាន (Logbook)': { kh: 'សៀវភៅតាមដាន (Logbook)', en: 'Monitoring Logbook' },
