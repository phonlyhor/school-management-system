...
import { FiHome, FiBookOpen, FiCalendar, FiEdit3, FiClock, FiUser, FiBell, FiPaperclip, FiAward } from 'react-icons/fi';
...
const menuItems = [
    ...
    { label: 'Homeroom Scores (ពិន្ទុថ្នាក់បន្ទុក)', path: '/teacher/homeroom-scores', icon: <FiAward /> },
